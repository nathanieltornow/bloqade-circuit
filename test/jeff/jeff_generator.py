...
class Gen:
    def __init__(self, rng: random.Random, probe: bool = False):
        ...
        multi-controlled gates, a zero step, an out-of-order hand-back."""
        self.rng = rng
    ...
    def make_helper(self, index: int):
        ...
        if self.probe and len(hand) >= 2 and self.rng.random() < 0.3:
            # out of order hand-back: refused by the conversion
